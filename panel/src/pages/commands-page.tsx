...
export function CommandsPage() {
  ...
  return <div className="page">
    ...
    <section className="page-section page-section--flush" aria-label="Comandos registrados">
      ...
      {filtered.length ? <><div className="table-scroll commands-table"><table><thead><tr><th>Comando</th><th>Origem</th><th>Estado</th><th>Versão</th><th>Disponibilidade</th><th><span className="sr-only">Ações</span></th></tr></thead><tbody>
